        ...
        <div className="upload-modal-hdr">
          <div>
            ...
            <div style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 4 }}>
              Each second-level folder becomes a collection (e.g. <code>City/Neighborhood/photo.jpg</code> → collection &ldquo;Neighborhood&rdquo;). Images without a second-level folder import without a collection. AI tags and location run automatically.
            </div>
          </div>
